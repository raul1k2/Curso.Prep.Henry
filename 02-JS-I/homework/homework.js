...
function suma(x, y) {
  // "x" e "y" son números
var sumar = x + y;  // Suma "x" e "y" juntos y devuelve el valor
return sumar;  // Tu código:
}
suma(5,6);// *****AL ESCRIBIR LA VARIABLE DE LA 'FUNCION' FUERA DE LA FUNCION CON CUALQUIER NUMEROS QUE YO ELIJA,ME VA DAR UN RESULTADO BASADO EN LA VARIABLE Q YO HAYA CREADO CON DETERMINADA OPERACION***
...
return Math.pow(num,3);  // Devuelve el valor de "num" elevado al cubo
  // Tu código:
}
...
function numeroRandom() {
 return Math.random(0,1); //Generar un número al azar entre 0 y 1 y devolverlo
...
return euro * 1.20;  //Supongamos que 1 euro equivale a 1.20 dólares. Escribe un programa que reciba
